...
import com.jerry.springcloud.service.imp.Test;
...
public class PaymentController {
    ...
    public Object discovery(){
        ...
        //获取具体服务下的实例列表
        List<ServiceInstance> instances = discoveryClient.getInstances("CLOUD-PAYMENTMAIN-SERVICE");
    ...
    public CommonResult getPaymentById(@PathVariable("id") Long id) {
        log.info(test.uuid + "Get from Bean");
    ...
    public ResponseEntity getError(@PathVariable("id") Long id) {
        return new ResponseEntity<>("This is a error", HttpStatus.BAD_REQUEST);
    }
}